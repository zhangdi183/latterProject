...
import Lchoose1 from '../L-components/L-chooseAddress1'
import chooseShopCarADD from '../L-components/L-chooseShopCarADD'
...
export default new Router({
  ...
  //  这个跳转到会员支付页面
    ...
    {path:'/chooseShopCarADD',component:chooseShopCarADD}
  ]
})
