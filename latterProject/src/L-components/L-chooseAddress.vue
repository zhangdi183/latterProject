<template>
    <div>
      ...
      <div class="alert-warning text-center" style="font-size: 0.65rem; color: #FF963F;padding: 0.2rem">为了满足商家的送餐要求,建议您从列表中选择地址</div>
      ...
      <div class="showData">
        <!--展示数据-->
          <div v-for="(data,index) in Arr" class="data">
            <router-link :to="{path:'/addShoppingAddress',query:{
